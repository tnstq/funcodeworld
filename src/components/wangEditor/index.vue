...
import {Url} from "@/assets/g";  //上传图片和视频的地址，根据后端给的地址确定
...
export default {
  ...
  methods: {
    ...
    seteditor() {
      ...
      this.editor.config.uploadImgServer = Url + '/wangEditor/uploadFile'// 填写配置服务器端地址
      ...
      this.editor.config.uploadVideoServer = Url + '/wangEditor/uploadFile'// 填写配置服务器端地址
